...
cookies.txt → son TUS cookies de YouTube/Google

auth_info/ → es la sesión de WhatsApp del bot

data/*.json → contienen datos personales

✅ Siempre verifica antes de subir:
bash
git ls-files | grep -E "cookies|auth_info|node_modules"
Si devuelve algo, detente y arréglalo.
